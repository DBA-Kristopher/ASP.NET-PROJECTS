...
public partial class frmLogin : System.Web.UI.Page
{
    ...
    protected void Login1_Authenticate(object sender, AuthenticateEventArgs e)
    {
        ...
        if (dsUserLogin.tblUserLogin.Count < 1)
        {
            ...
            if (clsBusinessLayer.SendEmail("dba.kristopher.Smith@gmail.com",
            "dba.kristopher.Smith@gmail.com", "", "", "Login Incorrect",
            "The login failed for UserName: " + Login1.UserName +
            " Password: " + Login1.Password))
            {
                Login1.FailureText = Login1.FailureText +
                " Your incorrect login information was sent to dba.kristopher.Smith@gmail.com";
            }
